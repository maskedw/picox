...
#if SPIFFS_USE_DBG != 0
    #define SPIFFS_DBG              x_printf
#else
    #define SPIFFS_DBG              1 ? (void)0 : (void)x_printf
#endif

#if SPIFFS_USE_GC_DBG != 0
    #define SPIFFS_GC_DBG           x_printf
#else
    #define SPIFFS_GC_DBG           1 ? (void)0 : (void)x_printf
#endif

#if SPIFFS_USE_CACHE_DBG != 0
    #define SPIFFS_CACHE_DBG        x_printf
#else
    #define SPIFFS_CACHE_DBG        1 ? (void)0 : (void)x_printf
#endif

#if SPIFFS_USE_CHECK_DBG != 0
    #define SPIFFS_CHECK_DBG        x_printf
#else
    #define SPIFFS_CHECK_DBG        1 ? (void)0 : (void)x_printf
#endif
